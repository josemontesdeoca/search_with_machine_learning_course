...
def create_query(user_query, click_prior_query, filters, sort="_score", sortDir="desc", size=10, source=None, useSynonyms=False):
    name_field_to_match = "name.synonyms" if useSynonyms else "name"
                        ...
                        "should": [  #
                            ...
                            },
                            {
                                "multi_match": {
                                    ...
                                    "fields": [f"{name_field_to_match}^10", "name.hyphens^10", "shortDescription^5",
...
if __name__ == "__main__":
    ...
    general.add_argument('--synonyms', type=bool, default=False, action=argparse.BooleanOptionalAction,
                         help='Search using synonyms. Default: False.')
    ...
    for line in sys.stdin:
        ...
        search(client=opensearch, user_query=query, index=index_name, useSynonyms=synonyms)
